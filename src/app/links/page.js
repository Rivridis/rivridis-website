...
export default function Page() {
    return (
        <main className="bg-[#889cb8] min-h-screen">
            ...
            <div className="flex flex-col items-center justify-center px-6 pb-6">
                ...
                <div className="space-y-4 w-full max-w-xl text-center">
                    ...
                    <div className="bg-[#0C1016] rounded-lg shadow p-5">
                        <Link href="https://ko-fi.com/rivridis" className="block text-lg text-[#b6ad90] hover:underline">
                            Kofi
                        </Link>
                    </div>
                    <div className="bg-[#0C1016] rounded-lg shadow p-5">
                        <Link href="https://www.instagram.com/rivridis" className="block text-lg text-[#b6ad90] hover:underline">
                            Instagram
                        </Link>
                    </div>
                    <div className="bg-[#0C1016] rounded-lg shadow p-5">
                        <Link href="https://github.com/Rivridis" className="block text-lg text-[#b6ad90] hover:underline">
                            Github
                        </Link>
                    </div>
                    <div className="bg-[#0C1016] rounded-lg shadow p-5">
                        <Link href="https://www.reddit.com/user/rivridis" className="block text-lg text-[#b6ad90] hover:underline">
                            Reddit
                        </Link>
                    </div>
                </div>
